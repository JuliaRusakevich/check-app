...
import static main.java.ru.clevertec.check.util.Constant.INTERNAL_SERVER_ERROR;
...
public class FileUtil {
    ...
    public static List<String> readContentFromCsvFile(String fileName) throws IOException {
        if (fileName == null) {
